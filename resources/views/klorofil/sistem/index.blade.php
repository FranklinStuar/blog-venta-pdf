		...
		<div class="panel-body">
			{!! Form::open(['route' => 'config.save','class'=>'form-horizontal']) !!}
				...
				<div class="form-group{{ $errors->has('host') ? ' has-error' : '' }}">
					<label for="host" class="col-md-4 control-label">Host del correo *</label>
					<div class="col-md-6">
				...
				<div class="form-group{{ $errors->has('drive') ? ' has-error' : '' }}">
					<label for="drive" class="col-md-4 control-label">Drive de servidor del correo *</label>
					<div class="col-md-6">
				...
				<div class="form-group{{ $errors->has('port') ? ' has-error' : '' }}">
					<label for="port" class="col-md-4 control-label">Puerto de acceso *</label>
					<div class="col-md-6">
				...
				<div class="form-group{{ $errors->has('encryption') ? ' has-error' : '' }}">
					<label for="encryption" class="col-md-4 control-label">Encriptación *</label>
					<div class="col-md-6">
