...
@section('script')
	<script src="{{ url('plugins/google-code-prettify/prettify.js') }}" type="text/javascript"></script>
	<script src="{{ url('plugins/jquery-hotkeys/jquery.hotkeys.js') }}" type="text/javascript"></script>
	<script src="{{ url('plugins/bootstrap-wysiwyg/bootstrap-wysiwyg.js') }}" type="text/javascript"></script>
...
<script>
	$(function(){
		...
		$("#description").attr("value", result.exampleMessage);
