...
class System extends Model
{
  ...
  protected $fillable = [
  	'facebook','instagram','youtube','email','direccion','telefono','celular','quienes_somos','cuentas_premium','publicidad','politicas_condiciones', 'role_id','password_email','host','drive','port','encryption',
  ];
